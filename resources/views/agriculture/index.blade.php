...
<head>
    ...
    <title>Équipements Agricoles - SOMAFIAM S.A</title>
    <meta name="description" content="Machines et équipements agricoles de pointe — SOMAFIAM S.A, votre partenaire pour l'agriculture moderne au Maroc.">
...
<body>
            ...
            <div class="row category-row">
                @foreach ($categories as $index => $categorie)
                    <div class="col-md-6 col-lg-4 category-item {{ $index >= 6 ? 'hidden-category' : '' }}">
                        <a href="{{ route('agricultureProducts.filterByCategory', ['category' => $categorie->id]) }}"
    ...
    <section class="additional-section wow fadeIn" data-wow-delay="0.1s">
        <div class="additional-content">
            <div class="additional-contentImg wow fadeIn" data-wow-delay="0.3s">
                <img src="{{ asset('agricultureBackgrounds/agricolBg.webp') }}" alt="Équipements Agricoles SOMAFIAM">
            </div>
            <div class="text-content wow fadeIn" data-wow-delay="0.5s">
                <h2>Agriculture durable, fiable et productive !</h2>
            </div>
        </div>
    </section>
    ...
    <section class="wow fadeIn" data-wow-delay="0.3s"
        ...
        <div class="container py-5 wow fadeIn" data-wow-delay="0.5s">
            <div class="row" id="products-container">
                @include('agriculture.productsMiniCatalogue', [
                    'products' => $products,
    ...
    <div class="hero-text" style="margin-top: 125px;"></div>
