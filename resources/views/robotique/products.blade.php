...
<head>
    ...
    <style>
        ...
        .prod-body { padding: 13px 15px 15px; flex: 1; display: flex; flex-direction: column; }

        .prod-subcat {
            font-size: 10px; font-weight: 700;
            letter-spacing: 1.5px; text-transform: uppercase;
            color: #F47920; margin: 0 0 6px 0;
        ...
        .products.list-view .product-card:hover { transform: translateX(4px); border-left-color: #F47920; border-bottom-color: transparent; }
