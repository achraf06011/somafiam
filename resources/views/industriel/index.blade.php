...
<head>
    ...
    <title>Équipements Industriels - SOMAFIAM S.A</title>
    <meta name="description" content="Découvrez notre gamme complète d'équipements industriels — moteurs, compresseurs, pompes, robinetterie, automatisation et plus. SOMAFIAM S.A, Casablanca.">
    ...
    <style>
        ...
        .cat-card__img--contain img {
            object-fit: contain;
        }
        .cat-card__img--contain-dark {
            padding: 8px;
            box-sizing: border-box;
        }
        .cat-card__img--contain-dark img {
            object-fit: contain;
        }
        ...
        .secondary-font,
        /* Theme 8 */
        .theme-8 .homepage__gallery-title,
        .theme-8 .homepage__about-title,
        .theme-8 .homepage__instagram-title,
        .theme-8 .homepage__video-section-title,
        .theme-8 .footer__callout-title,
        .theme-8 .header__button span,
        .theme-8 .navigation__lease span,
        .theme-8 .footer__title,
        /* Global Homepage */
        ...
        .floorplan-details-b__title span,
        .floorplan-details-c__title,
        .neighborhood-a__poi-category-header span,
        .gallery__tab,
        ...
        .fpm-unit-details__title,
        .fpm-en-floorplan-listing__title,
        .spm-floorplan-listing__title,
        .spm-unit-details__title,
        .reviews-manager__title,
        .retail-page__retailer-name,
        .landing-page__title h1,
        .fya__my-apartments-list-item-title,
        .fya__my-apartments-title,
        .fya__details-title,
        .fya__list-item-availability,
        .fya__list-item-title,
        .fya__step-header,
        .popdown__title-text,
...
<body>
    ...
    <div class="hero-text wow fadeIn" data-wow-delay="0.1s" style="margin-top: 10px;">
        <h1 class="company-name"
            ...
            background-image: linear-gradient(35deg, #181b1f 5%, #419ef5 40%);">
            Categories
        </h1>
    </div>
                            ...
                            <div class="cat-card__img">
                                ...
                                @else
                                    <div style="width:100%;height:100%;background:#dde4ee;display:flex;align-items:center;justify-content:center;">
                                        <i class="fa fa-image" style="font-size:48px;color:#8fa5c5;"></i>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="hero-text" style="margin-top: 75px;"></div>
    ...
    <section class="additional-section wow fadeIn" data-wow-delay="0.1s">
        <div class="additional-content">
            <div class="additional-contentImg wow fadeIn" data-wow-delay="0.3s">
                <img src="https://t4.ftcdn.net/jpg/08/12/64/65/360_F_812646509_Vx28n14USuaOODuSAGCr5QHSPLA6kd0Z.jpg"
                    alt="Équipements Industriels SOMAFIAM">
            </div>
            <div class="text-content wow fadeIn" data-wow-delay="0.5s">
                <h2>Équipements industriels durables, résilients et productifs !</h2>
            </div>
        </div>
    </section>
    ...
    <div class="hero-text wow fadeIn" data-wow-delay="0.1s" style="margin-top: 75px;">
        <h1 class="company-name"
            style="font-size: 32.5px; letter-spacing: 7.5px; padding: 25px 75px;
            background-image: linear-gradient(35deg, #181b1f 5%, #419ef5 40%);">
            Mini Catalogue
    ...
    <section class="wow fadeIn" data-wow-delay="0.3s"
        ...
        <div class="container py-5 wow fadeIn" data-wow-delay="0.5s">
            <div class="row" id="products-container">
                @include('industriel.productsMiniCatalogue', [
                    'products' => $products,
    ...
    <div class="text-center wow fadeIn" data-wow-delay="0.1s">
        <button id="view-all-btn" class="btn btn-primary mt-4"
            style="background-color: #1679a7; border-color: #1679a7;">
            Voir les Catégories des Produits
        </button>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (toggleButton) {
                toggleButton.addEventListener('click', function() {
                    ...
                    if (expanded && hiddenCategories.length > 0) {
                        setTimeout(function() {
                            hiddenCategories[0].scrollIntoView({ behavior: 'smooth', block: 'start' });
                        }, 50);
                    }
                });
            }
            ...
            if (viewAllBtn) {
                viewAllBtn.addEventListener('click', expandCategories);
            }
        });
