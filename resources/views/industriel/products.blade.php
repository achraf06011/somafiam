...
<head>
    ...
    <title>Produits - SOMAFIAM S.A</title>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <h6 class="wow fadeIn"data-wow-delay="0.7s">
                équipements industrielles / {{ $category->nomCategory ?? 'Tous' }}
            </h6>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <section class="products grid-view wow fadeIn" data-wow-delay="1.6s">
                @include('industriel.productsSection')
            </section>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#searchForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: '{{ route('industrielProducts.search') }}',
                    method: 'GET',
                    data: {
                        query: query,
