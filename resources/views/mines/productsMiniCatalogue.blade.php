                            ...
                            @foreach ($productChunk as $product)
                                <div class="col-md-6 col-lg-3 mb-4 mb-md-0"
                                    ...
                                    <div class="cardXCategory" style="border-radius: 12.5px;">
                                        <div style="height:130px;display:flex;align-items:center;justify-content:center;background:#fff;border-radius:8px 8px 0 0;padding:8px;margin-top:20px;">
                                            <img src="{{ asset('minesProducts/' . $product->imgProduct) }}"
                                                class="card-img-top"
