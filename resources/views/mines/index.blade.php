...
<head>
    ...
    <title>Mines - SOMAFIAM S.A</title>
    <meta name="description" content="Solutions et équipements spécialisés pour l'industrie minière — SOMAFIAM S.A, Maroc.">
...
<body>
    ...
    <section class="hero-section wow fadeIn" data-wow-delay="0.1s">
        <img class="hero-bg" src="{{ asset('Bg/Mines.jpg') }}" alt="Mines">
        <div class="hero-overlay"></div>
        <div class="hero-content wow fadeIn" data-wow-delay="0.4s">
            <span class="cat-label">Secteur</span>
            <h1>Mines</h1>
            <p>Solutions et équipements spécialisés pour l'industrie minière</p>
        </div>
    </section>
            ...
            <div class="row">
                @forelse ($categories as $index => $categorie)
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ route('minesProducts.filterByCategory', ['category' => $categorie->id]) }}"
        ...
        <section class="wow fadeIn" data-wow-delay="0.3s"
            ...
            <div class="container py-5 wow fadeIn" data-wow-delay="0.5s">
                <div class="row" id="products-container">
                    @include('mines.productsMiniCatalogue', [
                        'products' => $products,
