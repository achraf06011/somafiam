...
<head>
    ...
    <title>Produits Mines - SOMAFIAM S.A</title>
    ...
    <style>
        ...
        .overlay {
            ...
            background-image: url("{{ asset('Bg/Mines.jpg') }}");
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <h6 class="wow fadeIn" data-wow-delay="0.7s">
                équipements miniers / {{ $category->nomCategory ?? 'Tous' }}
            </h6>
        </div>
    </section>
    ...
    <script>
        $(document).ready(function() {
            $('#searchForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: '{{ route('minesProducts.search') }}',
                    method: 'GET',
                    data: {
                        query: query,
                        category: categoryId
